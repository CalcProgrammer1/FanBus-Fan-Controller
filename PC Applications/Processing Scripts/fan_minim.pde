...
void draw()
{
  ...
  char val2 = (char)(fft.getBand(150)*50);
  char val5 = (char)(fft.getBand(160)*50);
  char val8 = (char)(fft.getBand(170)*50);
  char val11 = (char)(fft.getBand(180)*50);
  char val1 = (char)(fft.getBand(250)*50);
  char val4 = (char)(fft.getBand(260)*50);
  char val7 = (char)(fft.getBand(270)*50);
  char val10 = (char)(fft.getBand(280)*50);
  char val = (char)(fft.getBand(350)*50);
  char val3 = (char)(fft.getBand(360)*50);
  char val6 = (char)(fft.getBand(370)*50);
  char val9 = (char)(fft.getBand(380)*50);
  
  char mycmd[] = {0xAA,0x21,val,0xFF};
