...
//Variables
char softcount = 0;   //Software counting byte
char pinlevelB = 0x3F; //Pin mask, port B (63 for 6 bits)
char pinlevelC = 0x3F; //Pin mask, port C (63 for 6 bits)

char compare[12];     //Compare Array
